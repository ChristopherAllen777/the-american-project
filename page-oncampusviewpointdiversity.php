<?php
/**
 * Template Name: On Campus / Viewpoint Diversity Page
 *
 * Template for On Campus / Viewpoint Diversity page.
 *
...
.btn-info {
    color: #fff;
    background-color: #7ec642; /* yellowgreen */
...
.btn-info:hover {
    color: #fff;
    background-color: #b5d49b; /* Light yellowgreen */
    border-color: #b5d49b; /* Light yellowgreen */
}
@media (max-width: 767px){
    h5.bigcitizen-header {
        text-align: center;
...
.oncampus-child {
    border-left: #7ec642; /* yellowgreen */
    border-width: 2px;
...
<div id="category-row" class="row">
    <div class="col-sm-2">
        <img id="category-icon" src="http://americastaging.wpengine.com/wp-content/uploads/2017/09/AP_asset_categorypage_circle-icon_600x600_on-campus.png" alt="Big Citizen Icon">
    </div>
    <div class="col-sm-10">
        <h1 class="bigcitizen-header"> On Campus / Viewpoint Diversity</h1>
...
<!-- Start Featured - On Campus / Viewpoint Diversity Loop -->
<!-- ================================================ -->
    <?php
    ...
    <div id="featured">
        ...
        <h5 class="bigcitizen-header"> On Campus / Viewpoint Diversity</h5>
            <div>
...
<?php    
          $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
          $args = array(
            'category__not_in' => 9, 5, 6, 4, 8, 3, 1,
            'category__in' => 7,
            'posts_per_page'  => 10,
            'paged' => $paged
          );

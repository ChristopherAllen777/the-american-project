<?php
/**
 * Template Name: U.S. Role In The World Page
 *
 * Template for U.S. Role In The World page.
 *
...
.btn-info:hover {
    color: #fff;
    background-color: #d8a59f; /* Light orange */
    border-color: #d8a59f; /* Light orange */
}
@media (max-width: 767px){
    h5.bigcitizen-header {
        text-align: center;
...
<div id="category-row" class="row">
    <div class="col-sm-2">
        <img id="category-icon" src="http://americastaging.wpengine.com/wp-content/uploads/2017/09/AP_asset_categorypage_circle-icon_600x600_us-role.png" alt="Big Citizen Icon">
    </div>
    <div class="col-sm-10">
        <h1 class="bigcitizen-header"> U.S. Role In The World </h1>
...
<!-- ================================================ -->
    <?php
          ...
          $args = array(
            'category__not_in' => 1,3,4,5,6,7,8,9,17,19,20,21,22,23,
            'category__in' => 18,
            'posts_per_page'  => 1,
            // 'paged' => $paged
          );
    ...
    <div id="featured">
        ...
        <h5 class="bigcitizen-header"> U.S. Role In The World</h5>
            <div>
...
<!-- Start - US Role In The World Loop -->
<!-- ================================================ -->
<?php    
          $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
          $args = array(

<?php
/**
 * Template Name: Thinktanks & Research Page
 *
 * Template for Thinktanks & Research page.
 *
...
.btn-info {
    color: #fff;
    background-color: #2B53AA; /* royalblue */
...
.btn-info:hover {
    color: #fff;
    background-color: #7f90b5; /* Light royalblue */
    border-color: #7f90b5; /* Light royalblue */
}
@media (max-width: 767px){
    h5.bigcitizen-header {
        text-align: center;
...
<div id="category-row" class="row">
    <div class="col-sm-2">
        <img id="category-icon" src="http://americastaging.wpengine.com/wp-content/uploads/2017/09/AP_asset_categorypage_circle-icon_600x600_thinktanks.png" alt="Big Citizen Icon">
    </div>
    <div class="col-sm-10">
        <h1 class="bigcitizen-header"> Thinktanks & Research </h1>
...
<!-- Start Featured - Thinktanks & Research Loop -->
<!-- ================================================ -->
    <?php
    ...
    <div id="featured">
        ...
        <h5 class="bigcitizen-header"> Thinktanks & Research</h5>
            <div>
...
<?php    
          $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
          $args = array(
            'category__not_in' => 9, 5, 6, 4, 7, 3, 1,
            'category__in' => 8,
            'posts_per_page'  => 10, 
            'paged' => $paged
          );

...
// /**
//  * Filter URL for Social Sharing. Checks for http or https. If not adds to custom field
//  */
...
//   );
// }
// add_action( 'init', 'executive_team' );
// function executive_team() {
//   register_post_type( 'executive_team',
//     array(
//       'labels' => array(
//         'name' => __( 'Executive Team' ),
//         'singular_name' => __( 'executive_team' )
//       ),
//       'public' => true,
//       'has_archive' => true,
//       'supports'      => array( 'title','editor'),
//       'taxonomies' => array('post_tag'),
//       'rewrite' => array( 'slug' => 'executive_team' )
//     )
//   );
// }

// add_action( 'init', 'advisory_listings' );
// function advisory_listings() {
//   register_post_type( 'advisory_listings',
//     array(
//       'labels' => array(
//         'name' => __( 'Advisory Listings' ),
//         'singular_name' => __( 'advisory_listings' )
//       ),
//       'public' => true,
//       'has_archive' => true,
//       'supports'      => array( 'title','editor'),
//       'taxonomies' => array('post_tag'),
//       'rewrite' => array( 'slug' => 'advisory_listings' )
//     )
//   );
// }

// add_action( 'init', 'air_rights' );
// function air_rights() {
//   register_post_type( 'air_rights',
//     array(
//       'labels' => array(
//         'name' => __( 'Air Rights' ),
//         'singular_name' => __( 'air_rights' )
//       ),
//       'public' => true,
//       'has_archive' => true,
//       'supports'      => array( 'title','editor'),
//       'taxonomies' => array('post_tag'),
//       'rewrite' => array( 'slug' => 'air_rights' )
//     )
//   );
// }

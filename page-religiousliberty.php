<?php
/**
 * Template Name: Religious Liberty Page
 *
 * Template for Religious Liberty page.
 *
...
.btn-info {
    color: #fff;
    background-color: #EEAA16; /* yellow */
...
.btn-info:hover {
    color: #fff;
    background-color: #e4d0a4; /* Light yellow */
    border-color: #e4d0a4; /* Light yellow */
}
@media (max-width: 767px){
    h5.bigcitizen-header {
        text-align: center;
...
<div id="category-row" class="row">
    <div class="col-sm-2">
        <img id="category-icon" src="http://americastaging.wpengine.com/wp-content/uploads/2017/09/AP_asset_categorypage_circle-icon_600x600_religious-freedom.png" alt="Religious Liberty Icon">
    </div>
    <div class="col-sm-10">
        <h1 class="bigcitizen-header"> Religious Liberty </h1>
...
<!-- Start Featured - Religious Liberty Loop -->
<!-- ================================================ -->
    <?php
    ...
    <div id="featured">
        ...
        <h5 class="bigcitizen-header"> Religious Liberty</h5>
            <div>

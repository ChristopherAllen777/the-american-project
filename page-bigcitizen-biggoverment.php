<?php
/**
 * Template Name: Big Citizen-Big Government Page
 *
 * Template for Big Citizen-Big Goverment page.
 *
...
<div id="category-row" class="row">
    <div class="col-sm-2">
        <img id="category-icon" src="http://americastaging.wpengine.com/wp-content/uploads/2017/09/AP_asset_categorypage_circle-icon_600x600_big-government.png" alt="Big Citizen Icon">
    </div>
    <div class="col-sm-10">
        <h1 class="bigcitizen-header"> On Conservatism </h1>
    ...
    <?php
          ...
          $args = array(
            'category__not_in' => 9, 6, 7, 5, 8, 4, 1, 3, 18,
            'category__in' => 17,
            'posts_per_page'  => 1,
            // 'paged' => $paged
          );
    ...
    <div id="featured">
        ...
        <h5 class="bigcitizen-header"> On Conservatism </h5>
            <div>
